...
const AdminIndustryTableComponent = props => {
...
AdminIndustryTableComponent.propTypes = {
  id: PropTypes.number,
...
AdminIndustryTableComponent.defaultProps = {
  id: '-',
  name: '-',
  isOdd: false,
  onShowDetails: () => null,
...
export default AdminIndustryTableComponent
