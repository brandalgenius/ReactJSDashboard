...
import InstitutionSearchComponent from './InstitutionSearch.component'
...
const InstitutionSearchContainer = props => {
  const { form } = props
...
const WrapperInstitutionSearchContainer = Form.create({
  name: 'UserListSearchContainer',
})(InstitutionSearchContainer)

export default WrapperInstitutionSearchContainer
